 ...
 *   Say for example you have four parameterized constructors, then four 
 *   copies of constructor blocks will be placed inside the constructor, one
 *   for each. Lets execute the below example and see the output. */
